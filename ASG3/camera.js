class Camera {
  constructor() {
    this.fov = 60;
    this.eye = new Vector3([0, 1.7, 8]);
    this.at = new Vector3([0, 1.7, 7]);
    this.up = new Vector3([0, 1, 0]);
    this.speed = 4.0;        // world units per second for smooth movement
    this.turnSpeed = 100;     // degrees per second for smooth Q/E turning
